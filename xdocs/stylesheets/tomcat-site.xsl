    ...
    <div>
      <div>
        ...
        <div class="asfLogo noPrint">
          <a href="http://www.apache.org/events/current-event.html" target="_blank"><img src="http://www.apache.org/events/current-event-234x60.png" alt="Upcoming Event" style="margin-right: 15px;"/></a>
